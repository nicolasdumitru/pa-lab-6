...
void multiple_dfs_without_clear_intentions(Graph *g, Stack *s1, Stack *s2) {
...
int main() {
    ...
    multiple_dfs_without_clear_intentions(g, s1, s2);

    printf("Nu se stie ce a dorit sa spuna, sa determine, sa calculeze sau sa "
           "afiseze autorul original al codului (deoarece nu afisa nimic si "
           "inca nu au fost predate grafurile la laborator), dar codul merge, "
           "asa cum s-a cerut, si acum avem clean code.");
